...
public abstract class Tag<T> implements Cloneable {
	...
	/**
	 * Calls {@link net.querz.nbt.tag.Tag#toString(int)} with an initial depth of {@code 0}.
	 * @see net.querz.nbt.tag.Tag#toString(int)
	...
	/**
	 * Calls {@link net.querz.nbt.tag.Tag#valueToString(int)} with {@link net.querz.nbt.tag.Tag#DEFAULT_MAX_DEPTH}.
	...
	/**
	 * Calculates the hash code of this Tag. Tags which are equal according to {@link net.querz.nbt.tag.Tag#equals(Object)}
	...
	public abstract net.querz.nbt.tag.Tag<T> clone();

	/**
	 * Escapes a string to fit into a JSON-like string representation for Minecraft
	 * or to create the JSON string representation of a Tag returned from {@link net.querz.nbt.tag.Tag#toString()}
