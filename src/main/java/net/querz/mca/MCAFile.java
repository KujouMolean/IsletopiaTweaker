...
public class MCAFile {
	...
	/**
	 * Calls {@link net.querz.mca.MCAFile#serialize(RandomAccessFile, boolean)} without updating any timestamps.
	 * @see net.querz.mca.MCAFile#serialize(RandomAccessFile, boolean)
