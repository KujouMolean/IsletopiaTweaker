...
public class IslandMobCap implements Listener, CommandExecutor, TabCompleter {
    ...
    public void onItem(ItemSpawnEvent event) {
        ...
        LocalIsland currentPlot = IslandManager.INSTANCE.getCurrentIslandIfLoaded(location);
        if (currentPlot == null) {
            return;
        }
    ...
    public void onEntitySpawn(EntitySpawnEvent event) {
        ...
        LocalIsland plot = IslandManager.INSTANCE.getCurrentIslandIfLoaded(event.getLocation());
        if (plot == null) {
            return;
        }
    ...
    public void onMobDeath(EntityDeathEvent event) {
        LocalIsland plot = IslandManager.INSTANCE.getCurrentIslandIfLoaded(event.getEntity().getLocation());
        if (plot == null) {
            return;
        }
        shouldUpdatePlot.add(plot.getIslandId());
