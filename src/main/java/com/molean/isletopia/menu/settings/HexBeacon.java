...
public class HexBeacon extends ChestMenu {
    ...
    public HexBeacon(PlayerPropertyManager playerPropertyManager, SidebarManager sidebarManager, ChargeCommitter chargeCommitter, Player player) {
        ...
        this.item(0, speedItem.build(), () -> {
            ...
            Tasks.INSTANCE.async(() -> new HexBeacon(playerPropertyManager, sidebarManager, chargeCommitter, player).open());
        });
