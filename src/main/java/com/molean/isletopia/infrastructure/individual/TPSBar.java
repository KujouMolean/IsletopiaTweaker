...
public class TPSBar implements Listener, CommandExecutor {
    public TPSBar() {
        ...
        Objects.requireNonNull(Bukkit.getPluginCommand("tpsbar")).setExecutor(this);
        ...
        Tasks.INSTANCE.intervalAsync(20, () -> {
            for (Player onlinePlayer : Bukkit.getOnlinePlayers()) {
                if (!PlayerPropertyManager.INSTANCE.isLoad(onlinePlayer.getUniqueId())) {
                    continue;

                }
                if (PlayerPropertyManager.INSTANCE.getPropertyAsBoolean(onlinePlayer, "TPSBar")) {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        boolean powerBar = PlayerPropertyManager.INSTANCE.getPropertyAsBoolean(player, "TPSBar");
        PlayerPropertyManager.INSTANCE.setPropertyAsync(player, "TPSBar", !powerBar + "");
        return true;
    }
}
